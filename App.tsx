    ...
    <div className="flex flex-col items-center justify-center h-screen text-center p-6 bg-red-50 dark:bg-gray-800">
        <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-2xl border border-red-200 dark:border-red-700 max-w-lg">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
                The application cannot connect to the backend services because the API Key is missing.
            </p>
            ...
            <a 
                ...
                className="inline-block bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-6 rounded-md transition-colors mb-6"
            >
                Get API Key from Google AI Studio
            </a>

            <p className="text-gray-600 dark:text-gray-400 text-sm">
                After getting the key, paste it into the <code className="bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded">firebase/config.ts</code> file.
            </p>
        </div>
    </div>
);
